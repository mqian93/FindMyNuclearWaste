...
A bubble chart is used with its area proportional to years.
Date: 11/8/25
Author: Melody Qian
"""
...
# Circlify computes a circle packing where circle areas reflect the "Years" values
...
# Outer boundary circle for visual context of the packing area
fig.add_shape(
...
# Draw each packed circle as a shape (so we can control exact radius/position)
...
# Add invisible markers to enable hover tooltips at circle centers
...
# Build a manual legend mapping each color to its event label
